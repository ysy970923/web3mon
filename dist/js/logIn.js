...
/** temp login : only  */
export var temporaryLogin = /*#__PURE__*/function () {
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          ...
          _context.next = 3;
          return window.wallet.verifyOwner(window.collection, window.tokenId);
        case 3:
          ...
          document.getElementById('profileHP').innerHTML = 'HP: ' + monsters[window.collection].health;
          document.getElementById('profileAP').innerHTML = 'AP: ' + monsters[window.collection].attacks[0].damage;
          ...
          worker.postMessage({
            url: playerUrl,
            leftSource: clothesList.find(function (doc) {
              return doc.id === chosenCloth;
            }).left,
            rightSource: clothesList.find(function (doc) {
              return doc.id === chosenCloth;
            }).right,
            downSource: clothesList.find(function (doc) {
              return doc.id === chosenCloth;
            }).down,
            upSource: clothesList.find(function (doc) {
              return doc.id === chosenCloth;
            }).up,
  ...
  return function temporaryLogin() {
 ...
 */
export var turnToGameScreen = function turnToGameScreen() {
