...
document.getElementById('start_login_button').addEventListener('click', function (e) {
  window.wallet.signIn();
});
document.getElementById('sign_out').addEventListener('click', function (e) {
  window.wallet.signOut();
});
var cols = document.querySelectorAll('.one_collection');
...
console.log('것들', _typeof(document.getElementsByClassName('one_collection')));